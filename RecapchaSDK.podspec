...
Pod::Spec.new do |spec|
  ...
  spec.description  = "đay là source code cua vtvlive"
  ...
  # Or just: spec.author    = "Minhvu6533"
  # spec.authors            = { "Minhvu6533" => "minhvv@vtvlive.vn" }
  # spec.social_media_url   = "https://twitter.com/Minhvu6533"
